    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("default_theme", models.CharField(choices=[("census-light", "Census Light"), ("census-dark", "Census Dark")], default="census-light", max_length=64)),
                ("icon_url", models.URLField(blank=True, default="")),
                ("font_heading", models.CharField(blank=True, default="", max_length=512)),
