...
class RetentionService:
    ...
    @classmethod
    def calculate_deletion_date(cls, closed_at, retention_months: int = DEFAULT_RETENTION_MONTHS):
        """
    ...
    def get_retention_extension_history(cls, survey: Survey) -> list:
        ...
        return list(
            DataRetentionExtension.objects.filter(survey=survey).order_by('-requested_at')
        )
