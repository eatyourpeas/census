...
class ExportService:
    ...
    5. Service returns download URL (valid for 7 days)
    6. User downloads file using token
    7. Service tracks download in audit trail
    """

    # Download URL validity period
    DOWNLOAD_URL_EXPIRY_DAYS = 7
    ...
    def create_export(
        ...
        # Calculate expiry
        expires_at = timezone.now() + timedelta(days=cls.DOWNLOAD_URL_EXPIRY_DAYS)
