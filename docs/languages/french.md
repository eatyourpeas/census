# 🇫🇷 Traduction Française des Chaînes d'Application
...
## Catégorie 2 : Gestion des Enquêtes (91 chaînes)

| # | Chaîne Anglaise | Traduction Française |
| :--- | :--- | :--- |
| 1. | This application is in development currently and should NOT be used for live surveys at the moment. | Cette application est actuellement en développement et ne doit PAS être utilisée pour des enquêtes en direct pour le moment. |
| 2. | Surveys for health care | Enquêtes pour les soins de santé |
| 3. | Go to Surveys | Aller aux Enquêtes |
| 4. | Drag-and-drop groups and questions, apply DaisyUI themes per survey, and control access with roles. | Faites glisser et déposez des groupes et des questions, appliquez des thèmes DaisyUI par enquête et contrôlez l'accès avec des rôles. |
| 5. | Create a survey | Créer une enquête |
| 6. | Invite your team, scope visibility by organisation and survey membership, and manage participation securely. | Invitez votre équipe, définissez la visibilité par organisation et adhésion à l'enquête, et gérez la participation en toute sécurité. |
| 7. | Manage surveys | Gérer les enquêtes |
...
| 10. | Organisation created. You are now an organisation admin and can host surveys and build a team. | Organisation créée. Vous êtes maintenant administrateur d'organisation et pouvez héberger des enquêtes et bâtir une équipe. |
| 11. | Question Group Builder | Constructeur de Groupes de Questions |
| 12. | Survey Dashboard | Tableau de Bord de l'Enquête |
...
| 18. | Overwrite survey questions? | Écraser les questions de l'enquête ? |
...
| 20. | Start typing (or use the sample markdown) to see the survey structure. | Commencez à taper (ou utilisez l'exemple de Markdown) pour voir la structure de l'enquête. |
...
| 25. | Required questions must be answered before the form can be submitted | Les questions obligatoires doivent être répondues avant que le formulaire puisse être soumis |
| 26. | Place the asterisk immediately after the question title text | Placez l'astérisque immédiatement après le texte du titre de la question |
...
| 29. | To mark a group as repeatable, add a line with **REPEAT** (or **REPEAT-5** to cap it) immediately above the group heading. | Pour marquer un groupe comme répétable, ajoutez une ligne avec **RÉPÉTER** (ou **RÉPÉTER-5** pour le limiter) immédiatement au-dessus de l'en-tête du groupe. |
| 30. | To define a child collection nested under a repeatable parent, indent with `>` and add **REPEAT** above the child group: | Pour définir une collection enfant imbriquée sous un parent répétable, indentez avec `>` et ajoutez **RÉPÉTER** au-dessus du groupe enfant : |
| 31. | Use `>` before REPEAT and the group heading to indicate one level of nesting. | Utilisez `>` avant RÉPÉTER et l'en-tête du groupe pour indiquer un niveau d'imbrication. |
...
| 34. | Branching rules must start with `? when` and reference a question or group ID in curly braces. | Les règles de branchement doivent commencer par `? when` et faire référence à un ID de question ou de groupe entre accolades. |
...
## Catégorie 6 : Texte Général de l'Interface Utilisateur (89 chaînes)
