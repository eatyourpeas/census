...
def test_followup_mc_single_option_structure(test_markdown):
    ...
    assert part_time_opt["followup_text"]["label"] == "Please specify your hours per week"
...
def test_followup_yesno_option_structure(test_markdown):
    ...
    assert no_opt["followup_text"]["label"] == "Is there anything that would change your mind?"
